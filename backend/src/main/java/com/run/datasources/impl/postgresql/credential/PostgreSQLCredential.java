package com.run.datasources.impl.postgresql.credential;
 ...
 * PostgreSQL 数据源凭证
 */
public class PostgreSQLCredential extends BaseDatasourceCredential {

    private final TextInputField host = new TextInputField(new TextLabel("主机地址"), true, "localhost");

    private final NumberInputField port = new NumberInputField(new TextLabel("端口"), true, 5432, 1, 65535);
