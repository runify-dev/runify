package com.run.workflow.deserialize.listskills;
...
public class ListSkillsDeserialize implements INodeDeserialize {

    @Override
    public boolean support(String type) {
        return "list-skills-node".equals(type);
    }
    ...
    public Map<String, Object> deserialize(JsonObject context) {
        ...
        if (context.containsKey("skills")) result.put("skills", context.getInteger("skills"));
