package com.run.workflow.deserialize.contextquery;
...
public class ContextQueryDeserialize implements INodeDeserialize {

    @Override
    public boolean support(String type) {
        return "context-query-node".equals(type);
    }
