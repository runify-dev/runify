...
public class WorkFlowManage {
     ...
     */
    private ThreadPoolExecutor threadPool = new ThreadPoolExecutor(4, 100, 30, TimeUnit.SECONDS, new LinkedBlockingQueue<>(10), Executors.defaultThreadFactory(), new ThreadPoolExecutor.AbortPolicy());
