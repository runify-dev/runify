 ...
 * 行式单选字段
 */
public class RadioRowField extends BaseField {

    private List<Object> optionList;
    private String labelField;
    private String valueField;

    public RadioRowField(BaseLabel label,
                         Boolean required,
                         Object defaultValue,
        ...
        super("RadioRow", label, required, defaultValue, showRules, attrs, props);
    ...
    public RadioRowField(BaseLabel label,
                         ...
                         Object defaultValue,
                         List<Object> optionList) {
        super("RadioRow", label, required, defaultValue, null, null, null);
        this.optionList = optionList;
