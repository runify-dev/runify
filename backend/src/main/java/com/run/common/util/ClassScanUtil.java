...
public class ClassScanUtil {
    ...
    public static <T> List<Class<? extends T>> getClassList(String packageName, Class<T> parentClass) {
        // 第一个class类的集合
                                ...
                                if (name.endsWith(".class")
                                    ...
                                    try {
                                        ...
                                        if (parentClass.isAssignableFrom(aClass)) {
                                            classes.add((Class<? extends T>) Class.forName(packageName
                                                    + '.' + className));
                                        }
    ...
    public static <T> void findAndAddClassesInPackageByFile(String packageName,
                                                            String packagePath, final boolean recursive, List<Class<? extends T>> classes, Class<T> parentClass) {
        // 获取此包的目录 建立一个File
