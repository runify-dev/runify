...
export const ResourceTypeNameMap: any = {
  'knowledge': '全部知识库',
  'application': '全部应用',
  'model': "全部模型"
}
 ...
 * @returns
 */
const resourceInfo: (resourceType: Resource, floderId: string, sourceId: string, loading?: Ref<boolean>) => Promise<Result<Node>> = (resourceType, floderId, sourceId, loading) => {
  if (floderId) {
