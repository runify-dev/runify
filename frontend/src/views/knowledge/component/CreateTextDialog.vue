<template>
  <Dialog v-model:visible="visible" modal header="新建文档" :style="{ width: '24rem' }">
    <div class="flex flex-col gap-1.5">
      <label class="text-sm font-medium text-surface-700">文档名称</label>
      <InputText v-model="name" type="text" placeholder="请输入文档名称" fluid class="!text-sm"/>
    </div>
    <template #footer>
