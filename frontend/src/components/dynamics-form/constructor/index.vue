<template>
  ...
  >
    <el-form-item
      :label="$t('dynamicsForm.constructor.field.label')"
      :required="true"
      prop="field"
      :rules="rules.field"
    >
    ...
    <el-form-item
      :label="$t('dynamicsForm.constructor.name.label')"
      :required="true"
      prop="label"
      :rules="rules.label"
    >
      <el-input
        ...
        :maxlength="64"
        show-word-limit
        :placeholder="$t('dynamicsForm.constructor.name.placeholder')"
      />
    </el-form-item>
    <el-form-item :label="$t('dynamicsForm.constructor.tooltip.label')">
      <el-input
        v-model="form_data.tooltip"
        :maxlength="128"
        show-word-limit
        :placeholder="$t('dynamicsForm.constructor.tooltip.placeholder')"
      />
    </el-form-item>
    <el-form-item
      :label="$t('dynamicsForm.constructor.required.label')"
      :required="true"
      prop="required"
    ...
    <el-form-item
      :label="$t('dynamicsForm.constructor.input_type.label')"
      :required="true"
      prop="input_type"
...
const rules = {
  label: [{ required: true, message: t('dynamicsForm.constructor.name.requiredMessage') }],
  field: [{ required: true, message: t('dynamicsForm.constructor.field.requiredMessage') }],
  required: [{ required: true, message: t('dynamicsForm.constructor.required.requiredMessage') }],
  input_type: [
    { required: true, message: t('dynamicsForm.constructor.input_type.requiredMessage') }
  ]
}
const getData = () => {
